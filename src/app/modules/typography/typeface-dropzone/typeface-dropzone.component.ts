...
import { CustomFont } from '../typeface-section/typeface.model';
import { FontManagerService } from '../typeface-editor/font-manager.service';
import { TypefaceDropzoneManager } from './typeface-dropzone-manager';
...
@Component({
  selector: 'app-typeface-dropzone',
  templateUrl: './typeface-dropzone.component.html',
  styleUrls: ['./typeface-dropzone.component.less']
})
export class TypefaceDropzoneComponent implements OnInit {
  ...
  fontManager: TypefaceDropzoneManager;
